...
localparam
    ...
    ADDR_ALPHA_V_DATA_0 = 5'h18,
    ADDR_ALPHA_V_CTRL   = 5'h1c,
    WRIDLE              = 2'd0,
    WRDATA              = 2'd1,
    WRRESP              = 2'd2,
    WRRESET             = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_ALPHA_V_DATA_0: begin
                    rdata <= int_alpha_V[7:0];
                end
            endcase
        end
    end
...
always @(posedge clk) begin
    if (rst)
        int_alpha_V[7:0] <= 0;
    else if (w_hs && waddr == ADDR_ALPHA_V_DATA_0)
        int_alpha_V[7:0] <= (WDATA[31:0] & wmask) | (int_alpha_V[7:0] & ~wmask);
end
