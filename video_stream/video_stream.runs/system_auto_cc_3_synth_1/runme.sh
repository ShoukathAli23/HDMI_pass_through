...
HD_PWD='E:/Work_Space/vivado_workspace/video_stream/video_stream.runs/system_auto_cc_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_auto_cc_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_auto_cc_3.tcl
