...
HD_PWD='E:/Work_Space/vivado_workspace/video_stream/video_stream.runs/system_m01_regslice_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_m01_regslice_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_m01_regslice_1.tcl
